...
import { DonationAddDialogComponent } from '../../admin/components/donation-add-dialog/donation-add-dialog.component';
...
@Component({
  ...
  styleUrl: './doctordashboard.component.scss',
})
export class DoctordashboardComponent {
  ...
  verifyUserRole() {
    ...
    if (token) {
      ...
      if (!decodedToken.includes('DOCTOR')) {
        this.location.back();
      } else {
